# Contributing to can-router

## Developing Locally

This section will walk you through setting up the [repository](https://github.com//can-router) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-router, you can start by going to its [fork page](https://github.com//can-router/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-router
```
